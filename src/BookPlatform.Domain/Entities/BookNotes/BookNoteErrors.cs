...
public static class BookNoteErrors
{
    ...
    public static readonly Error NotOwnerOfBookNote = Error.Create("You are not the owner of this book note");

    public static readonly Error NotFriendOfOwnerBookNote =
        Error.Create("You are not friend of owner of this book note");
    
    public static readonly Error IsPrivate =
        Error.Create("This book note is private and only owner can view it");
}